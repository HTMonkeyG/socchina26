...
void UiOcpMenu_Initialize(
  ...
  lv_obj_set_style_bg_color(self->screen, lv_color_hex(0xFF4444), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(self->label1, lv_color_hex(0xFFFFFF), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(self->label2, lv_color_hex(0xFFFFFF), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_arc_color(self->arc1, lv_color_hex(0xFFFFFF), LV_STATE_DEFAULT);
  lv_obj_set_style_arc_width(self->arc1, 7, LV_STATE_DEFAULT);
  lv_obj_set_style_arc_rounded(self->arc1, false, LV_STATE_DEFAULT);

  // Create line: self->line1
  self->line1 = lv_line_create(self->arc1);
  ...
  lv_obj_set_style_line_color(self->line1, lv_color_hex(0xFFFFFF), LV_STATE_DEFAULT);
  lv_obj_set_style_line_width(self->line1, 7, LV_STATE_DEFAULT);
